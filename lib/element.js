...
export function handleElement(element, context) {
    ...
    try {
        ...
        if (styles.transform && styles.transform !== 'none') {
            ...
            const left = context.options.captureArea.left ? context.options.captureArea.left : 0;
            ...
            const top = context.options.captureArea.top ? context.options.captureArea.top : 0;
            ...
            const strtransform = `translate(${centerx} ${centery}) ${styles.transform} translate(${-centerx} ${-centery})`;
